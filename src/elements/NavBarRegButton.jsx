  ...
  return (
    <React.Fragment>
      <a.div
        ...
        className="relative h-16 text-center flex items-center justify-center text:lg lg:text-2xl font-josefin w-20 md:w-40 lg:w-40 rounded-lg"
      >
        <a.div
          style={colorAnimation}
          className="rounded w-full h-full flex items-center justify-center"
        >
          <a.h1 style={textColorAnimation} className="">
            Get Started
          </a.h1>
        </a.div>
      </a.div>
