...
const About = () => {
  ...
  // const words = ['អ្នករចនា','អ្នកអភិវឌ្ឍន៍','អ្នកបង្កើត']
  const wait = 1000;
      ...
      <div data-aos="fade-left" className="relative">
        ...
        <div className="flex items-center absolute inset-0">
          <div className="text-center px-6 md:w-3/6 lg:w-3/6">
            ...
            <div className="mt-8">
              <a className="bg-primary px-4 py-2 lg:px-6 lg:py-4 rounded-full shadow-lg" href="/client"><Text id="about.learn_more" /></a>
            </div>
          </div>
