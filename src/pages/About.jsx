...
const About = () => (
  <div className="">
    <div className="relative">
      ...
      <div className="absolute inset-x-0 top-0">
        <div className="my-auto">
          <h1 className="text-6xl text-center py-5">Thinkers, Designers, Creators</h1>
        </div>
      </div>
      <div className="absolute inset-x-0 bottom-0 flex mb-6 items-center">
        <div className="px-5 flex-1 image">
    ...
    <div className="tools my-5">
      ...
      <div className="flex justify-center items-center content-center px-32">
        ...
        <Tool src="https://vuejs.org/images/logo.png" classImg="w-32 mx-auto"/>
      </div>
      <div className="flex justify-center items-center px-32">
        ...
        <Tool src="https://seeklogo.com/images/T/tailwind-css-logo-5AD4175897-seeklogo.com.png" classImg="w-32 mx-auto" />
...
const Tool = ({src, classImg }) => (
  <div className="flex-1 px-5 self-center hover:shadow-lg py-auto">
    <img className={`${classImg ? classImg : ''}`} src={src} alt="" />
  </div>
)
const Image = ({src, alt, clacss}) => (
  <img className={`hover:shadow-lg ${clacss}`} src={src} alt={alt} />
)
const Member = ({name, position, quote, photo, reverse}) => {
  const clacss = reverse ? "flex bg-gray-300 flex-row-reverse" : "flex bg-gray-200";

  return (
    <div className={clacss}>
      <div className={`w-2/3 px-10 mt-6 ${reverse ? null: 'text-right'}`}>
