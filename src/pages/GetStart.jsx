...
const GetStart = () => (
    <div className="container">
        <div className="m-5">
            <h1 className="text-center text-5xl">Have a Project ?</h1>
        ...
        <form className="w-full max-w-lg mx-auto">
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-for-email" type="eamil" placeholder="email@mail.com" />
                    <p className="text-red-500 text-xs italic">Please fill out this field.</p>
                </div>
                <div className="w-full md:w-1/2 px-3">
            ...
            <div className="flex flex-wrap -mx-3 mb-2">
                <button className="bg-blue-500 mx-auto my-3 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">SUBMIT NOW</button>
            </div>
        </form>
