  ...
  const middleSection = middleSectionDatas.map((item, index) => {
    return (
      <div
        key={index}
        className={
          (index === 0 ? "lg:pt-24 xl:pt-40" : "lg:pt-20 xl:pt-32") +
          " w-10/12 my-0 mx-auto pt-16 pb-5 md:w-full md:px-6 lg:px-12 xl:px-16 container"
        }
          ...
          {index % 2 === 0 ? (
            <>
              <div className="w-full md:w-1/2 md:pr-6">
                <div className="text-xl text-gray-1000 font-bold mb-5 mt-6 sm:text-xl sm:mt-6 md:text-2xl xl:text-3xl">
                  <Text id={item.title} />
                </div>
