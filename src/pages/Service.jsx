...
const Service = () => (
  <div className="w-full pt-12">
    <div className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-center text-gray-800">
      <span>
        Everything we do
        <br/>
        help you grow.
    ...
    {/* Web Design */}
    <div className="w-10/12 my-0 mx-auto pt-12 pb-10 lg:pt-24">
    ...
    <div className="mt-10 bg-gray-200 py-6 px-10 w-11/12 my-0 mx-auto xl:flex">
        <div className="xl:w-1/3 xl:px-1">
          <div className="font-bold text-gray-800 sm:text-2xl md:text-3xl lg:text-3xl">Branding</div>
        ...
        <div className="mt-6 xl:w-1/3 xl:mt-0 xl:px-1">
          <div className="font-bold text-gray-800 sm:text-2xl md:text-3xl lg:text-3xl">Website Optimization</div>
          <div className="whitespace-pre-wrap text-gray-700 text-base sm:text-lg lg:text-xl">
            {textWebOptimization}
          </div>
        </div>
        ...
        <div className="mt-6 xl:w-1/3 xl:mt-0 xl:px-1">
          <div className="font-bold text-gray-800 sm:text-2xl md:text-3xl lg:text-3xl">Website Support</div>
          <div className="whitespace-pre-wrap text-gray-700 text-base sm:text-lg lg:text-xl">
            {textWebSupport}
          </div>
        </div>
