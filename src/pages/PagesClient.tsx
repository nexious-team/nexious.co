...
function Project(props: ProjectProps) {
  const { name, ui, dashboard, link, href, bgColor } = props;
      ...
      <div className="mt-8 flex -mx-2">
        <div className="px-2 w-1/2">
          ...
          <div className="toi w-full h-96 rounded-lg group">
            <img
              className="toi-image w-full h-full object-cover object-top rounded-lg"
              src={ui}
              alt=""
            />
        ...
        <div className="px-2 w-1/2">
          ...
          <div className="w-full h-96 rounded-lg">
            <img
              className="w-full h-full object-fit object-top rounded-lg"
              src={dashboard}
              alt=""
            />
          </div>
